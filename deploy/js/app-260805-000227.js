...
const T = {};
T.travnik = mkTex('Trávník', '🌿', 11, false, function (n1, n2, x, y) {
const v = n1 - 0.5;
let r = 84 + v * 100 + n2 * 26;
let g = 158 + v * 55;
let b = 54 + v * 44 + n2 * 22;
if (n1 > 0.7) { r *= 0.8; g *= 0.8; b *= 0.8; }
if (n2 > 0.64 && hash2(x, y, 3) % 7 === 0) { r = 138; g = 172; b = 88; }
if (hash2(x, y, 5) % 101 === 0) { r = 170; g = 166; b = 150; }
out[0] = r | 0; out[1] = g | 0; out[2] = b | 0;
return out;
});
T.pisky = mkTex('Poušť', '🏜️', 22, false, function (n1, n2, x, y) {
const v = n1 - 0.5;
let r = 222 + v * 55;
let g = 192 + v * 48;
let b = 132 + v * 42;
const d = Math.sin((x & 127) / 128 * Math.PI * 4 + n1 * 6 + (y & 127) / 128 * Math.PI * 8);
if (d > 0.45) { r += 20; g += 18; b += 12; }
else if (d < -0.45) { r -= 16; g -= 14; b -= 10; }
if (hash2(x, y, 7) % 67 === 0) { r *= 0.85; g *= 0.85; b *= 0.85; }
out[0] = r | 0; out[1] = g | 0; out[2] = b | 0;
return out;
});
T.snih = mkTex('Sníh', '❄️', 33, false, function (n1, n2, x, y) {
const v = n1 - 0.5;
let r = 242 + v * 30;
let g = 246 + v * 30;
let b = 252 + v * 30;
if (n2 > 0.72) { r *= 0.88; g *= 0.9; b *= 0.94; }
if (hash2(x, y, 9) % 151 === 0) { r = 255; g = 255; b = 255; }
out[0] = r | 0; out[1] = g | 0; out[2] = b | 0;
return out;
});
T.sopka = mkTex('Sopka', '🌋', 44, true, function (n1, n2, x, y) {
const v = n1 - 0.5;
let r = 104 + v * 70;
let g = 94 + v * 60;
let b = 100 + v * 60;
if (n1 > 0.7) { r *= 0.72; g *= 0.72; b *= 0.72; }
if (n2 > 0.86 && hash2(x, y, 11) % 5 !== 0) { r = 226; g = 112; b = 42; }
if (n2 < 0.1 && hash2(x, y, 13) % 3 !== 0) { r = 58; g = 52; b = 58; }
out[0] = r | 0; out[1] = g | 0; out[2] = b | 0;
return out;
});
T.kamen = mkTex('Skály', '🪨', 55, false, function (n1, n2, x, y) {
const v = n1 - 0.5;
let r = 132 + v * 90;
let g = 136 + v * 85;
let b = 144 + v * 80;
if (n2 > 0.8) { r += 42; g += 42; b += 40; }
if (n2 < 0.12) { r *= 0.55; g *= 0.55; b *= 0.55; }
if (hash2(x, y, 15) % 83 === 0) { r *= 0.8; g *= 0.8; b *= 0.8; }
out[0] = r | 0; out[1] = g | 0; out[2] = b | 0;
return out;
});
...
tex.color(n1, n2, x, y);
if (rel <= 6) {
out[0] = clamp(out[0] + 16, 0, 255);
out[1] = clamp(out[1] + 16, 0, 255);
out[2] = clamp(out[2] + 16, 0, 255);
} else if (rel > 60) {
const k = clamp((rel - 60) / 140, 0, 1);
out[0] = clamp(out[0] * (1 - 0.3 * k), 0, 255);
out[1] = clamp(out[1] * (1 - 0.3 * k), 0, 255);
out[2] = clamp(out[2] * (1 - 0.3 * k), 0, 255);
}
...
let h = 250
+ 105 * Math.sin(x * 0.0029 + p1)
+ 62 * Math.sin(x * 0.0068 + p2)
+ 34 * Math.sin(x * 0.016 + p3)
+ 16 * Math.sin(x * 0.039 + p4);
